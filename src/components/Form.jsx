...
function Form({ route, method }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Registration form policy acceptance validation
    if (name === "Register" && !acceptedPolicies) {
      setError("Please accept the policy terms to register.");
      setLoading(false);
      return;
    }
